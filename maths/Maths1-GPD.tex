...
\For{iterations $k$ from 1 to $N$}{
	Generate $u \sim U(0, 1)$\;
	\For{locations $i$ from 1 to $n$}{
		Simulate $\tilde{\phi}_{new,i}$\;
...
\For{iterations $k$ from 1 to $N$}{
	\For{covariates $c$ from 1 to $p+1$}{
	
		Simulate ${\alpha_\phi}_{new,c}$\;
		Set $l_{new}$ = log full conditional of new vector ${\alpha_\phi}_{new}$\;
		Set $l_{old}$ = log full conditional of old vector $\alpha_\phi$\;
		Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2a1})\;
			\If{$a > u$}{
				Set $\alpha_\phi = {\alpha_\phi}_{new}$\;
			}

	}
	
	\For{covariates $d$ from 1 to $q+1$}{
	
		Simulate ${\alpha_\xi}_{new,d}$\;
		Set $l_{new}$ = log full conditional of new vector ${\alpha_\xi}_{new}$\;
		Set $l_{old}$ = log full conditional of old vector $\alpha_\xi$\;
		Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2a2})\;
			\If{$a > u$}{
				Set $\alpha_\xi = {\alpha_\xi}_{new}$\;
			}
...
\For{iterations $k$ from 1 to $N$}{
	\For{elements $c$ in the lower-triangle of the matrix $\beta_\phi$}{
	
		Simulate ${\beta_\phi}_{new,c}$\;
		Set $l_{new}$ = log full conditional of new matrix ${\beta_\phi}_{new}$\;
		Set $l_{old}$ = log full conditional of old matrix $\beta_\phi$\;
		Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2b1})\;
			\If{$a > u$}{
				Set $\beta_\phi = {\beta_\phi}_{new}$\;
			}

	}
	
	\For{elements $d$ in the lower-triangle of the matrix $\beta_\xi$}{
	
		Simulate ${\beta_\xi}_{new,d}$\;
		Set $l_{new}$ = log full conditional of new matrix ${\beta_\xi}_{new}$\;
		Set $l_{old}$ = log full conditional of old matrix $\beta_\xi$\;
		Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2b2})\;
			\If{$a > u$}{
				Set $\beta_\xi = {\beta_\xi}_{new}$\;
			}
...
\For{iterations $k$ from 1 to $N$}{
	...
	Simulate ${\nu_\phi}_{new}$\;
	Set $l_{new}$ = log full conditional of new value ${\nu_\phi}_{new}$\;
	Set $l_{old}$ = log full conditional of old value $\nu_\phi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2n1})\;
		\If{$a > u$}{
			Set $\nu_\phi = {\nu_\phi}_{new}$\;
		}
	
	Simulate ${\nu_\xi}_{new}$\;
	Set $l_{new}$ = log full conditional of new vector ${\nu_\xi}_{new}$\;
	Set $l_{old}$ = log full conditional of old vector $\nu_\xi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2n2})\;
		\If{$a > u$}{
			Set $\nu_\xi = {\nu_\xi}_{new}$\;
		}
}
...
\For{iterations $k$ from 1 to $N$}{
	...
	Set $l_{new}$ = log full conditional of new value ${\varsigma^2_\phi}_{new}$\;
	Set $l_{old}$ = log full conditional of old value $\varsigma^2_\phi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2vs1})\;
		\If{$a > u$}{
			Set $\varsigma^2_\phi = {\varsigma^2_\phi}_{new}$\;
		}
	
	Simulate ${\varsigma^2_\xi}_{new}$\;
	Set $l_{new}$ = log full conditional of new vector ${\varsigma^2_\xi}_{new}$\;
	Set $l_{old}$ = log full conditional of old vector $\varsigma^2_\xi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2vs2})\;
		\If{$a > u$}{
			Set $\varsigma^2_\xi = {\varsigma^2_\xi}_{new}$\;
		}
}
%\caption{Continued}
\end{algorithm*}
...
\For{iterations $k$ from 1 to $N$}{
	...
	Set $l_{new}$ = log full conditional of new value ${\tau^2_\phi}_{new}$\;
	Set $l_{old}$ = log full conditional of old value $\tau^2_\phi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2t1})\;
		\If{$a > u$}{
			Set $\tau^2_\phi = {\tau^2_\phi}_{new}$\;
		}
	
	Simulate ${\tau^2_\xi}_{new}$\;
	Set $l_{new}$ = log full conditional of new vector ${\tau^2_\xi}_{new}$\;
	Set $l_{old}$ = log full conditional of old vector $\tau^2_\xi$\;
	Set $a = \exp(l_{new} - l_{old} )$, that is, evaluate equation (\ref{eq:2t2})\;
		\If{$a > u$}{
			Set $\tau^2_\xi = {\tau^2_\xi}_{new}$\;
		}
}
%\caption{Continued}
\end{algorithm*}
